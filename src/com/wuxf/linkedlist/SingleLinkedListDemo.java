...
*/		
	...
	public static void reversetList(SingleLinkedList list) {
		...
		while(curHeroNode != null) {
			HeroNode nextHeroNode = curHeroNode.next;
			
			curHeroNode.next = list2.getHead().next;
			list2.getHead().next = curHeroNode;
			
			curHeroNode = nextHeroNode;
		}
		list.getHead().next = list2.getHead().next;
	}
